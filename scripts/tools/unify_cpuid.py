...
class Unifier:
    ...
    def generate_unified(self, entry_file: Path, output_file: Path):
        ...
        self.output_lines.append(" * ")
        self.output_lines.append(" * This is a unified single-header version of the AOCL-Utils CPUID")
        ...
        self.output_lines.append(" */")
        self.output_lines.append("")
        self.output_lines.append("#ifndef __AU_CPUID_UNIFIED_H__")
        self.output_lines.append("#define __AU_CPUID_UNIFIED_H__")
        self.output_lines.append("")
        ...
        self.output_lines.append("")
        self.output_lines.append("#endif /* __AU_CPUID_UNIFIED_H__ */")
...
def main():
    parser = argparse.ArgumentParser(
        description="Generate a single-header unification for the CPUID header-only API."
    )
    parser.add_argument(
        "--entry",
        type=Path,
        required=True,
        help="Entry header file (e.g., SDK/Include/Capi/au/cpuid/cpuid_header_only.h)",
    )
    parser.add_argument(
        "--sdk-include",
        type=Path,
    ...
    parser.add_argument(
        ...
        type=Path,
        required=True,
        help="Output unified header path (e.g., SDK/Include/Capi/au/cpuid/au_cpuid_unified.h)",
    )
    parser.add_argument(
        "--no-line-markers",
        action="store_true",
